...
class EngineBase(metaclass=EngineMeta):  # pylint: disable=R0902
    ...
    def copy_object(self, source_bucket, source_filename, destination_bucket, destination_filename):
        ...
        if not os.path.exists(source_path):
            raise FileNotFoundError(f"Source file {source_filename} not found in bucket {source_bucket}")
        #
    ...
    def move_object(self, source_bucket, source_filename, destination_bucket, destination_filename):
        ...
        # Use shutil.move for optimal performance (renames if same filesystem, otherwise copies)
